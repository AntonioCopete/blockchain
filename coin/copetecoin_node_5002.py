# -*- coding: utf-8 -*-
"""
Created on Sun Jan  2 22:46:43 2022

@author: AntonioCopete
"""

# Module 2 - Create a new Crypto Currency
...
# Create a web app
app = Flask(__name__)
# If error 500, reset flask 

#Create a node adress for port 5000
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Antonio2', amount = 10)
...
# Get the new completed blockchain
...
def add_transaction():
    ...
    if not all(key in json for key in transaction_keys):
        return 'Transaction elements are not valid', 400
    index = blockchain.add_transaction(json['sender'], json['receiver'], json['amount'])
    response = {'message': f'A new transaction will be added to the block {index}'}
